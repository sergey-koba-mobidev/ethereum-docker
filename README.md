...
Go to `contracts/samples` to find go examples interacting with Ethereum.

# Ethereum Docker

Thank you [https://github.com/Capgemini-AIE/ethereum-docker](https://github.com/Capgemini-AIE/ethereum-docker) for base docker-compose file for Ethereum.
